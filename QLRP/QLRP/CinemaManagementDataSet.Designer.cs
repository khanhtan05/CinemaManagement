...
namespace QLRP {
    ...
    public partial class CinemaManagementDataSet : global::System.Data.DataSet {
        ...
        public partial class NhanVienDataTable : global::System.Data.TypedTableBase<NhanVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NhanVienRow AddNhanVienRow(string TenNhanVien, string DienThoai, string TaiKhoan, string MatKhau, string VaiTro) {
...
namespace QLRP.CinemaManagementDataSetTableAdapters {
    ...
    public partial class NhanVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[NhanVien] WHERE (([MaNhanVien] = @Original_MaNhanVien) AND ([TenNhanVien] = @Original_TenNhanVien) AND ((@IsNull_DienThoai = 1 AND [DienThoai] IS NULL) OR ([DienThoai] = @Original_DienThoai)) AND ([TaiKhoan] = @Original_TaiKhoan) AND ([MatKhau] = @Original_MatKhau) AND ([VaiTro] = @Original_VaiTro))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[NhanVien] ([TenNhanVien], [DienThoai], [TaiKhoan], [MatKhau], [VaiTro]) VALUES (@TenNhanVien, @DienThoai, @TaiKhoan, @MatKhau, @VaiTro);
SELECT MaNhanVien, TenNhanVien, DienThoai, TaiKhoan, MatKhau, VaiTro FROM NhanVien WHERE (MaNhanVien = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhanVien] SET [TenNhanVien] = @TenNhanVien, [DienThoai] = @DienThoai, [TaiKhoan] = @TaiKhoan, [MatKhau] = @MatKhau, [VaiTro] = @VaiTro WHERE (([MaNhanVien] = @Original_MaNhanVien) AND ([TenNhanVien] = @Original_TenNhanVien) AND ((@IsNull_DienThoai = 1 AND [DienThoai] IS NULL) OR ([DienThoai] = @Original_DienThoai)) AND ([TaiKhoan] = @Original_TaiKhoan) AND ([MatKhau] = @Original_MatKhau) AND ([VaiTro] = @Original_VaiTro));
SELECT MaNhanVien, TenNhanVien, DienThoai, TaiKhoan, MatKhau, VaiTro FROM NhanVien WHERE (MaNhanVien = @MaNhanVien)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QLRP.Properties.Settings.Default.CinemaManagementConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaNhanVien, TenNhanVien, DienThoai, TaiKhoan, MatKhau, VaiTro FROM dbo.Nha" +
                "nVien";
        ...
        public virtual int Fill(CinemaManagementDataSet.NhanVienDataTable dataTable) {
        ...
        public virtual CinemaManagementDataSet.NhanVienDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CinemaManagementDataSet.NhanVienDataTable dataTable = new CinemaManagementDataSet.NhanVienDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CinemaManagementDataSet.NhanVienDataTable dataTable) {
        ...
        public virtual int Delete(int Original_MaNhanVien, string Original_TenNhanVien, string Original_DienThoai, string Original_TaiKhoan, string Original_MatKhau, string Original_VaiTro) {
        ...
        public virtual int Insert(string TenNhanVien, string DienThoai, string TaiKhoan, string MatKhau, string VaiTro) {
            if ((TenNhanVien == null)) {
        ...
        public virtual int Update(string TenNhanVien, string DienThoai, string TaiKhoan, string MatKhau, string VaiTro, int Original_MaNhanVien, string Original_TenNhanVien, string Original_DienThoai, string Original_TaiKhoan, string Original_MatKhau, string Original_VaiTro, int MaNhanVien) {
            if ((TenNhanVien == null)) {
                throw new global::System.ArgumentNullException("TenNhanVien");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(MaNhanVien));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TenNhanVien, string DienThoai, string TaiKhoan, string MatKhau, string VaiTro, int Original_MaNhanVien, string Original_TenNhanVien, string Original_DienThoai, string Original_TaiKhoan, string Original_MatKhau, string Original_VaiTro) {
            return this.Update(TenNhanVien, DienThoai, TaiKhoan, MatKhau, VaiTro, Original_MaNhanVien, Original_TenNhanVien, Original_DienThoai, Original_TaiKhoan, Original_MatKhau, Original_VaiTro, Original_MaNhanVien);
        }
    }
